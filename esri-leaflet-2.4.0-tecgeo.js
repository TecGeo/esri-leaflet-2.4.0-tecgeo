...
! function(t, e) {
    ...
    var gt = e.Layer.extend({
        ...
        /**
         * Modificação implementada por José Vitor | TecGeo 
         * Data: 11/05/2020
         * 
         * Mudança da posição do método callEnter para ser instanciado antes do método _reuseCell
         * O método _reuseCell não estava encontrando o método cellEnter pois no escopo da api este estava após a 
         * instanciação do método _reuseCell
        */
